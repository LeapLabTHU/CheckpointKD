...
__all__ = ['mobilenetv2_035', 'mobilenetv2_05', 'mobilenetv2_075', 'mobilenetv2',]
    # ['mobilenetv2_T_w', 'mobile_half']
...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, T,
        ...
        self.feature_num = self.last_channel
...
def mobilenetv2_035(T=6, W=0.35, num_classes=100):
    model = MobileNetV2(T=T, feature_dim=num_classes, width_mult=W)
    return model

def mobilenetv2_05(T=6, W=0.5, num_classes=100):
    model = MobileNetV2(T=T, feature_dim=num_classes, width_mult=W)
    return model

def mobilenetv2_075(T=6, W=0.75, num_classes=100):
    model = MobileNetV2(T=T, feature_dim=num_classes, width_mult=W)
    return model

def mobilenetv2(T=6, W=1, num_classes=100):
    model = MobileNetV2(T=T, feature_dim=num_classes, width_mult=W)
    return model
