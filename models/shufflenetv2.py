...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, ratio=1, class_num=100):
        ...
        self.feature_num = out_channels[3]
...
def shufflenetv2(num_classes, **kwargs):
    return ShuffleNetV2(class_num=num_classes, **kwargs)

def shufflenetv2_05(num_classes, **kwargs):
    return ShuffleNetV2(ratio=0.5, class_num=num_classes, **kwargs)