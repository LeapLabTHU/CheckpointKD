...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=100, atten=False):
...
def resnet18(num_classes, **kwargs):
    return ResNet(block=BasicBlock, num_blocks=[2,2,2,2], num_classes=num_classes, **kwargs)
...
def resnet152(num_classes, **kwargs):
    return ResNet(block=Bottleneck, num_blocks=[3,8,36,3], num_classes=num_classes, **kwargs)
